 ...
 */
public class PlayerListView extends javax.swing.JDialog {
  ...
  public PlayerListView(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
  ...
  private void initComponents() {
    ...
    jLabel1.setText("Set number of players:");
    ...
    labelJ1.setText("Player 1");
    labelJ1.setEnabled(false);

    labelJ2.setText("Player 2");
    labelJ2.setEnabled(false);

    labelJ3.setText("Player 3");
    labelJ3.setEnabled(false);

    labelJ4.setText("Player 4");
    labelJ4.setEnabled(false);

    jbJugar.setText("PLAY!");
    jbJugar.addActionListener(evt -> jbJugarActionPerformed(evt));
